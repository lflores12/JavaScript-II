...
// Problem 1
let alphaRunners = runners.map((person) => {
...
runners.forEach(function(runner){
    companyInfo.push(`${runner.first_name} ${runner.last_name} works for ${runner.company_name} `);
});

console.log(companyInfo)
// Problem 3

let largeDonations = runners.filter(function(donationSize){
